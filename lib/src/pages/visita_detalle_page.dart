...
class _VisitaDetallePageState extends State<VisitaDetallePage> {
                  ...
                  builder:
                    ...
                    if (snapshot.hasData) {
                      ...
                      return _imagenesVisitante(
                          visita.idVisitas, imagenes, visita);
                    } else {
  ...
  Widget _imagenesVisitante(
      String id, List<Map<String, dynamic>> imagenes, VisitaModel visita) {
  ...
  Widget _fechaVisita(VisitaModel visita) {
    return Column(
      ...
      children: [
        ...
        Visibility(
          visible: visita.fechaSalida != null && visita.fechaSalida!.isNotEmpty,
          child: Text(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(visita.tipoVisitante == '' ? 'Visita' : visita.tipoVisitante,
              style: utils.estiloTextoSombreado(16, dobleSombra: false)),
          Visibility(visible: visita.codigo == '', child: SizedBox(height: 10)),
