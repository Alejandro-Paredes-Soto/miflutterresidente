...
class CustomTabBar extends StatefulWidget {
  ///The color of this [CustomTabBar].
  final Color _backgroundColor;

  ///The color of the moving selection bar.
  final Color _foregroundColor;

  ///The widgets that are to be displayed as the tabs of this [CustomTabBar].
  final List<Widget> _widgets;

  ///The function that is to be used to get the current index/value of this [CustomTabBar].
  final Function _valueGetter;

  ///The function that is to be called when the current index/value of this [CustomTabBar] changes.
  ...
  ///The border radius that is to be used to display this [CustomTabBar] and the moving selection bar. The default value corresponds to the default iOS 13 value.
  final BorderRadius borderRadius;

  ///The curve which this [CustomTabBar] uses to animate the switching of tabs.
  final Curve curve;

  ///The duration that is to be used for the animations of the moving selection bar.
  final Duration duration;

  ///Set this value to true if you want this [CustomTabBar] to expand to fill the available gap. Do not set both [allowExpand] and [allowScrollable] to true.
  final bool allowExpand;

  ///Set this value to true if you want to allow this [CustomTabBar] to be scrollable. Do not set both [allowExpand] and [allowScrollable] to true.
  final bool allowScrollable;

  ///Set this value to true if you want this [CustomTabBar] to have a restricted size even while [allowScrollable] is set to true.
  final bool fittedWhenScrollable;

  ///Set this value to true if you want this [CustomTabBar] to remind the user that it is scrollable with an animation.
  final bool animateWhenScrollable;

  ///Set this value to true if you want this [CustomTabBar] to continue reminding the user that it is scrollable with an animation until it is scrolled by the user.
  final bool animateUntilScrolled;

  ///The gap that is to be shown on the left and right sides of this [CustomTabBar] if [allowScrollable] is set to true.
  final double outerHorizontalPadding;

  ///The gap that is to be shown on the top and bottom sides of this [CustomTabBar] if [allowScrollable] is set to true.
